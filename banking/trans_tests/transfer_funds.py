...
withdrawl = models.SAVINGSTRANS(TransId=101, CustNum=2, AcctNum=2, DepositAmt=0, WithdrawlAmt=10, TransDate=trans_date)
print("\n\n - withdraw funds from checking trans: " + str(withdrawl))
session.add(withdrawl)

deposit = models.CHECKINGTRANS(TransId=101, CustNum=2, AcctNum=2, DepositAmt=10, WithdrawlAmt=0, TransDate=trans_date)
